            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo  $isChekedText  ?></label>
                    <div class="col-sm-10">
                      <?php if ( $category_description[$language['language_id']]['isCheked'] == true) { ?>
                      <div class="col-sm-6">  <input type="radio" id = "r1" name="isCheked" value="1" checked="checked" /> <label> <?php echo $chekedAnsYes; ?> </label></div>
                      <div class="col-sm-6"><input type="radio" id = "r2" name="isCheked" value="0" /> <label> <?php echo $chekedAnsNo; ?> </label></div>
                      <script type="text/javascript">
                        $("#r1").click();
                        </script>
                    </div>
                      <?php } else { ?>
                      <div class="col-sm-6"><input type="radio" id = "r1" name="isCheked" value="1"  /> <label> <?php echo $chekedAnsYes; ?> </label></div>
                      <div class="col-sm-6"><input type="radio" id = "r2" name="isCheked" value="0" checked="checked" /> <label> <?php echo $chekedAnsNo; ?> </label></div>
                      <script type="text/javascript">
                        $("#r2").click();
                        </script>
                    </div>
