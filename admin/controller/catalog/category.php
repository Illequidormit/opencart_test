...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$data['isChekedText'] = $this->language->get('isChekedText');
		$data['chekedAnsYes'] = $this->language->get('chekedAnsYes');
		$data['chekedAnsNo'] = $this->language->get('chekedAnsNo');
		...
		if (isset($this->request->post['isCheked'])) {
		    $data['isCheked'] = $this->request->post['isCheked'];
		} else {
		    $data['isCheked'] = $this->config->get('isCheked');
		}
